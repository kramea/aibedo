...
from aibedo_salva.utilities.naming import get_group_name, get_detailed_name, clean_name
from aibedo_salva.utilities.utils import get_logger, no_op
...
def log_hyperparameters(
    ...
    # Add a clean name for the model, for easier reading (e.g. aibedo_salva.model.MLP.AIBEDO_MLP -> MLP)
