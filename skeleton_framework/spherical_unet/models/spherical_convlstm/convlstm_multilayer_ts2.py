...
class SphericalConvLSTMAutoEncoder(nn.Module):
    ...
    def __init__(self, pooling_class, N, depth, laplacian_type, input_channels, output_channels):
        ...
        self.convlstm11 = ConvLSTM(input_channels, 16, 3,  self.laps[5], True, True, False)
        self.convlstm12 = ConvLSTM(16, 32, 3,  self.laps[5], True, True, False)
        self.convlstm13 = ConvLSTM(32, 64, 3,  self.laps[5], True, True, False)
        self.convlstm14 = ConvLSTM(64, 128, 3,  self.laps[5], True, True, False)
        self.convlstm15 = ConvLSTM(128, 256, 3,  self.laps[5], True, True, False)
        self.convlstm16 = ConvLSTM(256, output_channels, 3,  self.laps[5], True, True, False)
