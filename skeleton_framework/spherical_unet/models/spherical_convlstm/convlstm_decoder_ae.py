...
class ConvLSTM_Decoder(nn.Module):
    ...
    def __init__(self, unpooling, laps, kernel_size, out_channels):
        ...
        self.dec_l1 = ConvLSTM_SphericalChebBNPoolCheb(512, 512,  512, laps[1], self.unpooling, self.kernel_size)
        self.dec_l2 = ConvLSTM_SphericalChebBNPoolCheb(512, 256, 256, laps[2], self.unpooling, self.kernel_size)
        self.dec_l3 = ConvLSTM_SphericalChebBNPoolCheb(256, 128, 128, laps[3], self.unpooling, self.kernel_size)
        self.dec_l4 = ConvLSTM_SphericalChebBNPoolCheb(128, 64, 64, laps[4], self.unpooling, self.kernel_size)
